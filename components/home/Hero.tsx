...
function Hero() {
  return (
    <>
      ...
      >
        <p className="text-xl mb-5">Haseeb Asad - Full-Stack Engineer & Software Developer</p>
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg">
          Building <span className="heroShiny1 text-fun-pink">scalable systems</span> and{" "}
          <span className="heroShiny2 text-fun-pink">driving innovation</span> through
          technology.
          <img
